...
def run_demo(inputs):
    ...
    impuestoelectricidad = impuesto_electricidad(tipo_calefaccion) 
    impuestogas = impuesto_gas(tipo_calefaccion) 
    gasto_CAL = (coste_fijoCALreparto*12 + coste_variableCAL*consumo_calefaccion + alquiler_equiposCAL*12 + impuestogas*consumo_calefaccion + impuestoelectricidad*coste_variableCAL*consumo_calefaccion)*(1+factor_ivacal(tipo_calefaccion, provincia)/100) 
